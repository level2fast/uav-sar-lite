...
% Find the number of complete blocks required to cover the area of interest(2 blocks in this case)
...
Kr              = 0.72135e+12;   % FM rate of radar pulse (Hz/s) (i.e. chirp rate)
Tr              = 41.75e-6;      % Chirp duration (s)
Vr              = 7100;          % Effective Radar velocity (m/s)
% -------------------------------------------------------------------------
